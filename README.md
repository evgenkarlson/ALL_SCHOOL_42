 ...
 * Для ускорения процесса перевода и понимания содержимого pdf файлов используйте кроссплатформенный перевочик текста [Crow Translate](https://crow-translate.github.io/). Он использует `api` таких ресурсов как: google, yandex и bing.
