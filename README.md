...
## Введение
Этот репозиторий содержит все задания программы обучения французской школы программирования ["Ecole 42"](https://www.42.fr/), которая в игровой форме позволяет самостоятельно развить навыки программирования, помогая с нуля получить востребованную профессию.
