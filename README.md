...
В этом репозиторий содержатся все задания по основному обучению,в Школе 42. 

Для последователного перемещения по заданиям вы можете скачать и использовать карту Графов: [[Holy Graph]](https://github.com/evgenkarlson/Subjects___School_42/blob/master/00_Projects__(%D0%9E%D1%81%D0%BD%D0%BE%D0%B2%D0%BD%D0%BE%D0%B5_%D0%9E%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5)/Holy_Graph.png).

Двигаясь по карте графов и выполняя задания основного обучения Школы 42 вы сформируете у себя фундаментальные технические навыки. А выполнение всех заданий этого обучения, в конечном итоге, позволит понимать любой язык программирования, а сама программа разовьет у каждого своё собственное понимание парадигм программирования. Что дает каждому необходимую основу для профессиональной интеграции.
 
Основной курс содержит задания с проектами по разработке программного обеспечения, которые будут погружать вас в суть операционных систем, сетей, облаков, содержащихся в них служб, развивая у вас навыки программирования и открывая для вас мир цифровой деятельности. 
...
За время обучения по программе вы приобретете навыки:
...
Идея обучения Школы 42  состоит в том, чтобы на выходе выпускники обладали практическим опытом и могли сразу начать работу на средних или высоких должностях.
