 ...
 * SCHOOL 42 - это французская школа программирования, состоящая из целой сети школ по всему миру. Она обладает своей собственной внутренней системой, которая позволяет самостоятельно выбирать направление, языки и учебные проекты которые вы будете реализовывать в рамках основного курса для обучения программированию.[[ филиал этой школы в Роосии ]](https://21-school.ru/)
 
 * Основной курс уже содержит задания с проектами по разработке программного обеспечения, которые будут погружать вас в суть операционных систем, сетей, облаков и содержащихся в них служб, развивая у вас навыки программирования (Пример: 42sh - хорошо известный пользователям Unix интерпретатор команд - это ключевая программа для понимания работы операционной системы, которую необходимо полностью воссоздать в рамках одного из проектов основного курса).
 
 * За время обучения вы приобретете навыки системного программирования, навыки эффективного и безопасного управления инфраструктурами и различными типы архитектур, навыки системного и сетевого администрирования, так же знания угроз и уязвимостей информационной безопасности, необходимые всем специалистам по компьютерной безопасности, способным предотвращать и противодействовать хакерским атакам, и многое другое.
