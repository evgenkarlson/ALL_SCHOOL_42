...
> Для ускорения процесса перевода и понимания содержимого pdf файлов используйте кроссплатформенный перевочик текста [Crow Translate](https://crow-translate.github.io/).(При переводе текста не забывайте о том что символы перевода текста на следующую строку может восприниматься переводчиками как конец предложения!)
