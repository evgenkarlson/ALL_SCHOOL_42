 ...
 * Для ускорения процесса перевода и понимания содержимого `pdf` файлов с заданиями используйте кроссплатформенный перевочик текста [Crow Translate](https://crow-translate.github.io/). Для перевода он использует `api` таких ресурсов как: google, yandex и bing.
