...
Проекты и задания позволят вам самостоятельно развить навыки программирования, помогая с нуля получить востребованную профессию. Они дадут каждому своё собственное понимание парадигм программирования. А практический опыт и знаниями, полученые при выполнении заданий и проектов Школы 42, дадут вам необходимую основу для профессиональной интеграции.
...
Одни представления вам будет легче развить инстинктивно, в то время как другие потребуют от вас дополнительных усилий. Основываясь на этом наблюдении, обучение в Школе 42 делится на части. 

Программа обучения индивидуализирована. Здесь каждый с течением времени каждый прогрессирует сам по себе, в своем собственном темпе, а не в соответствии со всем классом студентов (где самый поздний элемент замедляет работу всей группы). 
...
[Проекты основного обучения](https://github.com/evgenkarlson/Subjects___School_42/tree/master/00_Projects__(%D0%9E%D1%81%D0%BD%D0%BE%D0%B2%D0%BD%D0%BE%D0%B5_%D0%9E%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5)/)  представляют собой следующий этап программы обучения программированию. Все проекты основного обучения сгруппированы по направлениям, которые представлены в виде ветвей. Каждый последующий проект выбранной вами ветви сложнее предыдущего и может быть решен только с помощью навыков полученных в предыдущих пректах.

Для продвижения по заданиям/проектам основного обучения Школы 42 используйте карту [Holy Graph](https://github.com/evgenkarlson/Subjects___School_42/blob/master/00_Projects__(%D0%9E%D1%81%D0%BD%D0%BE%D0%B2%D0%BD%D0%BE%D0%B5_%D0%9E%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5)/Holy_Graph.png)
