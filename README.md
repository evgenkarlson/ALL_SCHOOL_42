...
Проекты и задания позволят вам самостоятельно развить навыки программирования, а практический опыт и знаниями, полученые при выполнении заданий и проектов Школы 42, дадут вам необходимую основу для профессиональной интеграции, помогая с нуля получить востребованную профессию. 
...
Программа обучения индивидуализирована. Здесь каждый с течением времени прогрессирует сам по себе, в своем собственном темпе, а не в соответствии со всем классом студентов (где самый поздний элемент замедляет работу всей группы), получает таким образом своё собственное понимание парадигм программирования.
