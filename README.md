 ...
 * ШКОЛА 42 - это французская школа программирования, состоящая из целой сети школ по всему миру, обладающая своей собственной внутренней системой, которая в игровой форме помогает участникам этой школы развиваться в программировании. [[ филиал этой школы в Роосии ]](https://21-school.ru/)

 * Программа обучения позволяет самостоятельно выбирать направление, языки и учебные проекты которые вы будете реализовывать в рамках основного курса.
 ...
 * Обучение в по программе школы 42 начинается с басейна по языку Си. Именно здесь вас будет ждать полное погружение в глубокую часть кода, которое позволит по-настоящему открыть для себя школу, ее уникальный метод обучения и, прежде всего, что такое программирование на самом деле.

 * Основной курс уже содержит задания с проектами по разработке программного обеспечения, которые будут погружать вас в суть операционных систем, сетей, облаков и содержащихся в них служб, развивая у вас навыки программирования, а так же умение адаптироваться и мыслить по-другому (Пример: 42sh - хорошо известный пользователям Unix интерпретатор команд - это ключевая программа для понимания работы операционной системы, которую необходимо полностью воссоздать в рамках одного из проектов основного курса).
...
> #### Как считают представители учреждения, на обучение придётся тратить до 40 часов в неделю.

> #### Идея обучения в том, чтобы на выходе выпускники обладали практическим опытом и могли сразу начать работу на средних или высоких должностях.

# 0. Документация, обязательная для прочтения перед началом прохождения обучения:
