...
Здесь вы получите своё собственное понимание парадигм программирования.

Программа обучения индивидуализирована. Здесь каждый с течением времени прогрессирует сам по себе, в своем собственном темпе, а не в соответствии со всем классом студентов (где самый поздний элемент замедляет работу всей группы). 
