...
>
> Хочу обратить ваше внимание на [CROW TRANSLATE](https://crow-translate.github.io/) - кроссплатформенный перевочик текста, который ОЧЕНЬ сильно мне помог ускорить процесс перевода и понимания содержимого документов. Для перевода она использует `api` таких ресурсов как: `google`, `yandex` и `bing`.
>
