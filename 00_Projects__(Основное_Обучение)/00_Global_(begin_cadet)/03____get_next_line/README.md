...
Благодаря проекту `get_next_line` вы, наконец, сможете написать функцию, которая позволит вам читать строку, заканчивающуюся символом новой строки из файлового дескриптора. Вы сможете добавить эту функцию в свой `libftf` и, что самое главное, используйте его во всех будущих проектах, которые потребуют этого.
