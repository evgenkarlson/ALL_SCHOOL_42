...
![7](src/7_empty_betwen_declaration.png)
...
![8](src/8_transfer_long_line.png)
...
![17](src/17_names_macros_and_preprocessor.png)

* Символы, следующие за `#if`, `#ifdef` или `#ifndef`, должны с отступами в один пробел на каждом уровне.

![18](src/18_spacees_between_macros_and_preprocessor.png)
