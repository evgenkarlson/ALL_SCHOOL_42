![pageimage](https://github.com/evgenkarlson/ALL___Subjects___School_42/blob/master/Notes_to_help/src/white/page1image3852832-small-13.png)
...
* Все ваши файлы кода C должны соответствовать стандарту 42. Стандарт будет проверен вашими корректорами и малейшая стандартная ошибка даст оценку 0 для вашего проекта или к вашему упражнению.
...
![3](src/white/3_block.png)

* Вы должны сделать отступ в своем коде используя табуляцию из 4 пробелов (это не эквивалентно 4 пробелам, это действительно должна быть табуляция). В своей базовой конфигурации ваш редактор может вставлять пробелы вместо табуляции, будьте осторожны. Обратитесь к документации вашего издателя, если сомневаетесь.
...
![7](src/white/7_empty_betwen_declaration.png)
...
![8](src/white/8_transfer_long_line.png)
...
![9](src/white/9_function_option.png)
...
* Вам необходимо поместить табуляцию перед идентификатором при объявлении структуры, перечислении или объединении.

![12](src/white/12_tab_struct.png)

* При объявлении переменной типа struct, enum или union вы помещаете в тип только пробел.

![13](src/white/14_typedef_two_tab.png)

* Вы должны использовать табуляцию между двумя параметрами typedef.

![14](src/white/14_typedef_two_tab.png)
...
![17](src/white/17_names_macros_and_preprocessor.png)

* Символы, следующие за `#if`, `#ifdef` или `#ifndef`, должны с отступами в один пробел на каждом уровне.

![18](src/white/18_spacees_between_macros_and_preprocessor.png)
